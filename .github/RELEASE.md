...
| --- | --- | --- | --- |
| `better_effect` | `0.1.1` | `better_effect-v0.1.1` | `better_effect-v{{version}}` |
| `better_effect_flutter` | `0.1.1` | `better_effect_flutter-v0.1.1` | `better_effect_flutter-v{{version}}` |
| `better_effect_analyzer` | `0.1.3` | `better_effect_analyzer-v0.1.3` | `better_effect_analyzer-v{{version}}` |

...
enum BetterEffectDependencyKind { constructor, contextual, resource }

/// Why a Module is selected as a graph root.
enum BetterEffectGraphRootKind { complete, inferred, selected }
...
final class BetterEffectGraphLocation
    implements Comparable<BetterEffectGraphLocation> {
...
final class BetterEffectGraph {
  BetterEffectGraph({
    ...
    required Iterable<String> unreachableProviderIds,
       ...
       diagnostics = List<BetterEffectGraphDiagnostic>.unmodifiable(
         diagnostics,
       ),
       ...
       dependenciesById =
           UnmodifiableMapView<String, BetterEffectGraphDependency>(
             <String, BetterEffectGraphDependency>{
               for (final dependency in dependencies) dependency.id: dependency,
             },
           );
  ...
  Map<String, Object> toJson() => <String, Object>{
    ...
    'project': <String, Object>{'name': projectName, 'root': '.'},
